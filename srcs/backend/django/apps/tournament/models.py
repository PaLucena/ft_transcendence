...
class Tournament(models.Model):
	...
	creator = models.ForeignKey(AppUser, on_delete=models.SET_NULL)
	created_at = models.DateTimeField(auto_now_add=True)
	participants = models.ManyToManyField(AppUser, related_name='participants', deafult=list) #if deleting, needs to marked as "deleted user"
	...
	#pending_invitations = models.ManyToManyField(AppUser, related_name='pending', deafult=list)